...
code1 = "1c0111001f010100061a024b53535009181c"
code2 = "686974207468652062756c6c277320657965"
code1 = hex_to_binary(code1)
code2 = hex_to_binary(code2)
result = binary_xOR(code1,code2)
result = binary_to_hex(result)
print("746865206b696420646f6e277420706c6179" == result) 
print(result)
